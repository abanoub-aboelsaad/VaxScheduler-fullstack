...
namespace api.Migrations
{
    ...
    [Migration("20240424005958_initssssssssssss")]
    partial class initssssssssssss
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "a5a1a07b-990e-4ac8-91c2-73a244acae3d",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "1ccb1271-cf2f-4031-a2db-e8911fe5488b",
                            Name = "VaccinationCenter",
                            NormalizedName = "VaccinationCenter"
                        },
                        new
                        {
                            Id = "c1449e92-4144-44af-921f-5ec8a1639662",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("api.Models.Vaccine", b =>
                {
                    ...
                    b.Property<int>("TimeGapFirstSecondDoseInDays")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("api.Models.Reservation", b =>
                {
                    ...
                    b.HasOne("api.Models.VaccinationCenter", "VaccinationCenter")
                        .WithMany("Reservations")
            ...
            modelBuilder.Entity("api.Models.VaccinationCenter", b =>
                {
                    b.HasOne("api.Models.AppUser", "AppUser")
                        ...
                        .HasForeignKey("api.Models.VaccinationCenter", "ManagerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
